    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('videojuegos.update', $videojuego) }}" class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    <x-input-label for="desarrollador" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Desarrollador
                    </x-input-label>
                    <x-text-input name="desarrollador" type="text" id="desarrollador" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        :value="old('desarrollador', $videojuego->desarrollador)" />
